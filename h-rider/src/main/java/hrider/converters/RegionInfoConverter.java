...
public class RegionInfoConverter extends JsonConverter {
    ...
    private static class RegionInfoWrapper {
        ...
        private TableName NewtableName;
        ...
        RegionInfoWrapper(HRegionInfo info) {
        	NewtableName = info.getTable();
            tableName = Bytes.toStringBinary(info.getTable().getName());
        ...
        public HRegionInfo toHRegion() {
            HRegionInfo info = new HRegionInfo(
            		NewtableName, Bytes.toBytesBinary(startKey), Bytes.toBytesBinary(endKey), split, regionID);
