...
public class Connection {
    ...
    public void loadTable(String tableName, String path) throws IOException, TableNotFoundException {
        ...
        StoreFile.Reader reader = new StoreFile(fs, new Path(path), this.getConfiguration(),new CacheConfig(this.getConfiguration()), BloomType.NONE).getReader();
        ...
        //    SchemaMetrics.configureGlobally(this.getConfiguration());
            ...
            do {
                KeyValue kv = (KeyValue) scanner.next();
